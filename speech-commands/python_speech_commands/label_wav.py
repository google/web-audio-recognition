...
def run_graph(input_data, labels, input_layer_name, output_layer_name,
              num_top_predictions):
...
def label_wav(wav, labels, graph, input_name, output_name, how_many_labels):
  ...
  # Perform preprocessing that web model cannot do
  wav_data = wavio.read(wav)[1]
  ...
  run_graph(spec, labels_list, input_name, output_name, how_many_labels)
